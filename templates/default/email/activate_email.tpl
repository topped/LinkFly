...
<head>
    ...
    <title>{$setting_site_name} - Activate E-Mail</title>
    <style>
        body {
        ...
        <td align="center" valign="top">
            <table border="0" cellpadding="20" cellspacing="0" width="600" id="emailContainer">
                ...
                <tr>
                    <td valign="top">
                        <b>Hi,</b><br/><br/>
                       welcome to {$setting_site_name}! You need to activate your e-mail by clicking on the following link:<br/>

                        <a href="{$mail['activation_link']}">{$mail['activation_link']}</a><br/><br/>
